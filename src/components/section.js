...
export default class Section extends Component {
  render() {
    ...
    return (
      <div className="info section" id="Info" style={{ backgroundImage: `url(${BgImage})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
