...
export default class Risotto extends Component {
  constructor() {
    super();
    this.state = {
      search: ''
    ...
    return (
      <Layout>
        <SEO
          ...
          keywords={[`Metafuni Chef`, `Italian`, `World`, `Cooking`, `Risotto`, `Recipes`, `Creative`, `Authentic`, `Traditional`]}
        />
        <div className="site-container blogs-page" id="Risotto">
          <div className="container">
            ...
            <div className="see-more" style={{margin: '0', textAlign: 'end', maxWidth: '200px'}}>
              ...
              <h1 className="line-heading h2">Risotto Recipes</h1>
            </div>
            <input
              type="text"
