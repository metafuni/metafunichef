  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title="Main Recipes"
          keywords={[`Metafuni Chef`, `Italian`, `World`, `Cooking`, `Side`, `Recipes`, `Creative`, `Authentic`, `Traditional`]}
        />
        <div className="site-container blogs-page" id="Side">
          <div className="container">
            <div className="section-head" style={{display: 'flex', justifyContent: 'space-between'}}>
              <h1 className="line-heading h2">Side Recipes</h1>
