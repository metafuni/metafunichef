  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title="Main Recipes"
          keywords={[`Metafuni Chef`, `Italian`, `World`, `Cooking`, `Main`, `Recipes`, `Creative`, `Authentic`, `Traditional`]}
        />
        <div className="site-container blogs-page" id="Main">
          <div className="container">
            ...
            <div className="see-more" style={{margin: '0', textAlign: 'end', maxWidth: '200px'}}>
              ...
              <h1 className="line-heading h2">Main Recipes</h1>
            </div>
            <input
              type="text"
